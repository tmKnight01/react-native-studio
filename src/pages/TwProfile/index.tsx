...
import Avatar, {AVATAR_SIZE_MAP} from './components/Avator';
...
const AVATAR_SIZE_VALUE = 64; // AVATAR_SIZE_MAP[AVATAR_SIZE];
      ...
      <Animated.View
        ...
        <Animated.View
          ...
          <Animated.View style={profileImageScaleStyle}>
            <TouchableOpacity>
              <Avatar size={AVATAR_SIZE} source={{uri: PROFILE_PICTURE_URI}} />
            </TouchableOpacity>
          </Animated.View>
  ...
  return (
    <LargeHeader
      ...
      <Text style={styles.text}>
        Founder of <Text style={styles.primaryText}>@codeherence</Text> •
        Helping companies develop and enhance their React Native apps
      </Text>
